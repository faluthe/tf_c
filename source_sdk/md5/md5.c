...
void md5_init(struct md5_context_t *ctx)
{
...
void md5_update(struct md5_context_t *ctx, unsigned char *buf, unsigned int len)
{
    unsigned int t;
...
void md5_final(unsigned char digest[16], struct md5_context_t *ctx)
{
    unsigned int count;
    unsigned char *p;
